...
<div class="main">
    <div class="headerInfo">
        ...
        <div class="op1">
            ...
            <div class="shoucang">
                <img class="icon" alt="" src="${pageContext.request.contextPath}/images/zw_images/shoucang.svg">
                <a href="">收藏</a>
            </div>
            <%--<div class="jingzhengli">--%>
                <%--<img class="icon" alt="" src="${pageContext.request.contextPath}/images/zw_images/jingzhengli.svg">--%>
                <%--<a href="">竞争力分析</a>--%>
            <%--</div>--%>
        </div>
        <div class="op2">
            <button id="submitBtn" type="button" class="btn">
                <%--<img class="icon" alt="" src="${pageContext.request.contextPath}/images/zw_images/shenqingzhiwei.svg">--%>
                <%--申请职位--%>
            </button>
        </div>
    </div>
    <div>
        <div class="companyContent">
            ...
            <div class="part">
                <h4>任职要求</h4>
                <div class="content">
                    ${requestScope.companyJobVO.job.jobDemand}
                </div>
            </div>
            <div class="part">
                <h4>公司地址</h4>
                <div class="content">
                    <label>上班地址</label>
                    <span>${requestScope.companyJobVO.company.companyAdrrDetail}</span>
                </div>
            </div>
            <div class="part">
                <h4>公司信息</h4>
        ...
        <div class="companyInfo">
            ...
            <div class="left">
                <%--<p class="at">--%>
                    <%--<img class="icon" alt="" src="${pageContext.request.contextPath}/images/zw_images/qizhi.svg">--%>
                    <%--<span>${requestScope.companyJobVO.company.}民营公司</span>--%>
                <%--</p>--%>
                <p class="at">
